...
export const jupProgram = new PublicKey(
  "JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4"
);

export const feeAccount1 = new PublicKey(
...
export const getRandomJitoAccount = () =>
  jitoAccounts[Math.floor(Math.random() * jitoAccounts.length)];
export const getRandomJitoUrl = () =>
  jitoUrls[Math.floor(Math.random() * jitoUrls.length)];
...
export async function createVtxWithOnlyMainSignerAndTables(
  ixs,
  wallet,
  tables,
  blockhash
